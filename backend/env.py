...
WASHING_USER_AGENT = os.getenv("WASHING_USER_AGENT", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36")
WASHING_REQUEST_TIMEOUT = int(os.getenv("WASHING_REQUEST_TIMEOUT", "30"))
